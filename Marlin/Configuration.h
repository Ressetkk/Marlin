...
#define STRING_CONFIG_H_AUTHOR "(Ressetkk, custom config for Anycubic Vyper)" // Who made the changes.
...
#define PROBE_TARE
  ...
  #define PROBE_TARE_PIN PB13    // Override default pin
  #if ENABLED(PROBE_ACTIVATION_SWITCH)
...
#define DGUS_LCD_UI_CREALITY_TOUCH
  ...
  #define DGUS_LCD_UI_CREALITY_TOUCH_ORIENTATION 3 // Orientation: 0, 1, 2, 3 for 0,90,180,270 degrees respectively
#endif
